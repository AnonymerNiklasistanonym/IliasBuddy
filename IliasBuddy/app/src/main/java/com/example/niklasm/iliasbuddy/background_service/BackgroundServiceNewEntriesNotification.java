...
public class BackgroundServiceNewEntriesNotification {
    ...
    public static void show(final Context CONTEXT, final String CONTENT_TITLE, final String CONTENT_TEXT, final String[] CONTENT_TEXT_ARRAY, final Intent ON_CLICK, final int MESSAGE_COUNT, final String URL) {
        ...
        final Notification NOTIFICATION = IliasBuddyNotificationHelper.createNewEntryNotification(CONTEXT,
                ...
                CONTENT_TEXT, CONTENT_TEXT_ARRAY, ON_CLICK, MESSAGE_COUNT, URL);
