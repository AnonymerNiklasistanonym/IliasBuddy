...
public class SettingsActivity extends AppCompatPreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(final SharedPreferences sharedPreferences,
        ...
        Log.d("SettingsActivity", "Preference was changed >> " + KEY);

        switch (KEY) {
            case "activate_background_notifications":
                // Start/Stop background service if setting was changed
                if (IliasBuddyPreferenceHandler.getBackgroundNotificationsEnabled(this, true)) {
                ...
                break;
            case "sync_frequency":
                // Restart background service if sync frequency changes
                if (IliasBuddyPreferenceHandler.getBackgroundNotificationsEnabled(this, true)) {
                    BackgroundServiceManager.stopBackgroundService(this);
                    BackgroundServiceManager.startBackgroundService(this);
                }
                break;
            case "enable_campus_shortcut":
                IliasBuddyBroadcastHandler.sendBroadcastEnableShortcutCampus(this);
                break;
            case "enable_setup_shortcut":
                IliasBuddyBroadcastHandler.sendBroadcastEnableShortcutSetup(this);
                break;
            case "enable_dev_shortcut":
                IliasBuddyBroadcastHandler.sendBroadcastEnableShortcutDev(this);
                break;
            default:
        }
    }
